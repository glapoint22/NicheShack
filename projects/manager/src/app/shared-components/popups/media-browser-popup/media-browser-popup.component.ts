...
export class MediaBrowserPopupComponent extends PopupComponent implements OnInit {
  ...
  setMediaSearch() {
    ...
    let searchResults = onInputChange.pipe(debounceTime(250), switchMap(() => {
      if (searchInput.value == '') {
        ...
        this.selectedMediaItemIndex = this.mediaLists[this.indexOfSelectedMediaList].findIndex(x => x.url == this.media.url);
        return of();
      }
  ...
  onMediaSelect(mediaItem: MediaItem) {
    if (mediaItem == null) {
      this.media.url = null;
      // if (this.media != null) this.media.url = null;
    } else {
  ...
  loadMedia(): Observable<MediaItem[]> {
    if (this.indexOfSelectedMediaList == MediaType.Image) {
      ...
      let image3: MediaItem = new MediaItem(MediaType.Image); image3.name = 'Image 3'; image3.id = 'potyuoptuw'; image3.url = '6e1659b63e5643e0a9039064b4a52e12.png';
    ...
    if (this.indexOfSelectedMediaList == MediaType.BannerImage) {
      ...
      let image2: MediaItem = new MediaItem(MediaType.BannerImage); image2.name = 'Banner Image 2'; image2.id = 'qweuywesdo'; image2.url = 'a1d9302640ae40a989e9d23e06b5afae.png';
      let image3: MediaItem = new MediaItem(MediaType.BannerImage); image3.name = 'Banner Image 3'; image3.id = 'potyuoptuw'; image3.url = '07989637795744629a0e979416b6586d.jpg';
      return of([image1, image2, image3]).pipe(delay(1000));
    }
